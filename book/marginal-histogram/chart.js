async function drawScatter() {
  ...
  function onVoronoiMouseEnter(event, datum) {
    ...
    const tooltipY = yScale(yAccessor(datum)) + dimensions.margin.top - 4; // bump up so it doesn't overlap with our hover circle
  ...
  function isDayWithinRange(d, minDateToHighlight, maxDateToHighlight) {
